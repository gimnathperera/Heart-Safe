...
const Home = () => {
  ...
  const PositivePrediction = () => (
    <>
      <Ionicons name='md-checkmark-circle' size={72} color='#4AD295' />
      <Text style={{ padding: 10, fontSize: 16 }}>
        You are safe! No Tubacilosis detected.
      </Text>
      <TouchableOpacity
        style={styles.checkButton}
        onPress={() => setModalVisible(!modalVisible)}
      >
        <Text style={{ color: '#fff' }}> Check prediction report</Text>
      </TouchableOpacity>
    </>
  );
            ...
            <View style={styles.innerCard}>
              ...
              <View style={{ paddingLeft: 10 }}>
                <Text style={{ padding: 8, fontSize: 16 }}>
                  <Ionicons name='heart-half' size={18} color='#FFC0CB' />
                  {'    '}
